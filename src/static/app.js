            ...
            ${details.participants.length > 0
              ? `<ul>${details.participants.map((participant) => `
                  <li>
                    ...
                    <button type="button" class="delete-participant" data-activity="${name}" data-participant="${participant}" aria-label="Unregister ${participant}" title="Unregister participant">&times;</button>
                  </li>`).join("")}</ul>`
