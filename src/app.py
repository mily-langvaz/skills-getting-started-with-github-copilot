...
activities = {
    ...
    "Tennis Club": {
        ...
        "max_participants": 16,
        "participants": ["madison@mergington.edu", "lucas@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Music Ensemble": {
        "description": "Orchestra, choir, and band performances",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["noah@mergington.edu", "ava@mergington.edu", "grace@mergington.edu"]
    },
    "Debate Club": {
